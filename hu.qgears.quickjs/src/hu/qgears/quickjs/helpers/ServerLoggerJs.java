...
public class ServerLoggerJs extends HtmlTemplate {
	...
	/** Insert into page with an IndexedComm type WS connection alive towards the server.
	 * @param parent
	 * @param indexedCommAccessor
	 */
